...
equation
  ...
  // Feedforward action: feed inflow directly to balance detected leak
  Qff = Qleak;

  // Combined PID + Feedforward control
  Qin = max(0.0, min(10.0, Kp * error + Ki * error_integral + Kd * error_derivative + Qff));
